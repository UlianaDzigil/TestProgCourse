...
<table border="0">
    ...
    <tr>
        ...
        <td class="article">
            ...
            <form action="DellByName.jsp" name="Deleting student:">
                <p>Student ID:<input type="text" name="dellId" required>
                </p>
                <input type="submit" value="Delete">
            </form>
            <form action="DellByGroup.jsp" name="Deleting group:">
            ...
            <form action="MoveById.jsp" name="Moving student to another group:">
            ...
            <form action="RedByName.jsp" name="Student edit:">
