...
<table border="0" class="header1">
    ...
    <tr>
        ...
        <td class="article">
            <table border = "1" align="top" class="article1">
                <tr>
                    <td > Student name </td>
                ...
                <c:forEach items="${names}" >
                    <tr>
                        <td height="10"><%= names.get(i)%></td>
                        <td height="10"><%= surnames.get(i)%></td>
                        <td height="10"><%= scores.get(i)%></td>
                        <td height="10"><%= groupes.get(i)%></td>
                        <c:if test="${isAdmin == true}">
                        <td><%= ides.get(i)%></td>
                        </c:if>
                    </tr>
