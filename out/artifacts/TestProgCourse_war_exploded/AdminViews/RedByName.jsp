...
<%
    String givenId = request.getParameter("redIdOfStud");
    String a1 = request.getParameter("newStudentName");
    String a2 = request.getParameter("newStudentSurname");
    int a3 = Integer.parseInt(request.getParameter("newStudentScore"));
//    request.setAttribute("gr", givenGroup);

    base.redactStudent(givenId, a1, a2, a3);
